...
function downloadToast(){
  const toast=$('#download-toast');clearTimeout(downloadToastTimer);
  toast.textContent='✓ 已加入下载列表';toast.hidden=false;
  downloadToastTimer=setTimeout(()=>{toast.hidden=true},3000);
}
