...
const GAMES = Object.freeze([
  ...
  {id:'wuwa',name:'鸣潮',gameBananaId:20357,skinsCategoryId:29524,charactersCategoryId:29524,importer:'WWMI',icon:'wuwa-icon.png',logo:'wuwa-logo.svg',background:'wuwa-background.jpg'}
].map(Object.freeze));
function getGame(id) {
