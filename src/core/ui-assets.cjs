...
const UI_ASSETS = ['index.html', 'style.css', 'app.js', 'home-background.js', 'program-tabs.js', 'library-categories.js', 'dialog-stack.js', 'hotkey-overlay.html', 'hotkey-overlay.css', 'hotkey-overlay.js', 'genshin-background.jpg', 'zzz-background.jpg', 'hsr-background.jpg', 'wuwa-background.jpg', 'genshin-icon.png', 'genshin-logo.png', 'zzz-icon.png', 'hsr-icon.png', 'wuwa-icon.png', 'zzz-logo.svg', 'hsr-logo.png', 'wuwa-logo-zh.png', 'app-icon.png'];
