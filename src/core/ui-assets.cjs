...
const UI_ASSETS = ['index.html', 'style.css', 'app.js', 'home-background.js', 'program-tabs.js', 'library-categories.js', 'dialog-stack.js', 'genshin-background.jpg', 'zzz-background.jpg', 'hsr-background.jpg', 'genshin-icon.png', 'genshin-logo.png', 'zzz-icon.png', 'hsr-icon.png', 'zzz-logo.svg', 'hsr-logo.png', 'app-icon.png'];
