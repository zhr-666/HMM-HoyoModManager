...
- XXMI Launcher is not bundled, downloaded, configured or launched by this application. Users select an existing GIMI, ZZMI, SRMI or WWMI folder. [XXMI source and GPLv3 license](https://github.com/SpectrumQT/XXMI-Launcher).
...
鸣潮默认背景取自[库洛游戏国服启动器配置](https://prod-alicdn-gamestarter.kurogame.com/launcher/launcher/50004_obOHXFrFanqsaIEOmuKroCcbZkQRBC7c/G153/index.json)于 2026-09-24 指向的[首帧图片](https://hw-pcdownload-qcloud.aki-game.net/launcher/clientUpload/kp82e0hn4uq2qqwz80.webp)，随包裁切、压缩为 1920×1080 JPEG；方形图标取自[库洛游戏 App Store 页面](https://apps.apple.com/us/app/wuthering-waves/id6475033368)的官方 App 图标；简体中文文字 Logo 取自[鸣潮中国官网](https://mc.kurogames.com/static4.0/assets/logo-zh-516e75ae.png)。官方动态背景由用户获取或启用自动更新后下载到本机 `data`，不随应用打包。版权归库洛游戏等原权利人，不适用本项目 MIT 代码许可证。
