...
鸣潮默认背景取自[库洛游戏官方网站](https://wutheringwaves.kurogames.com/website-preface/video/bg/bg-poster.png)，随包转成 1920×1080 JPEG；方形图标取自[库洛游戏 App Store 页面](https://apps.apple.com/us/app/wuthering-waves/id6475033368)的官方 App 图标；文字 Logo 取自 [Wikimedia Commons 上的鸣潮 Logo](https://commons.wikimedia.org/wiki/File:Wuthering_Waves_logo.svg)。用户按需获取的最新背景来自库洛官方启动器 CDN，仅缓存到本机 `data`。版权归库洛游戏等原权利人，不适用本项目 MIT 代码许可证。
