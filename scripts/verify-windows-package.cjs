...
(async()=>{
  ...
  for(const file of ['src/core/character-groups.cjs','src/ui/dialog-stack.js','src/core/dependency-prompts.cjs','src/core/app-update.cjs','src/core/update-helper.cjs','src/core/app-update.ps1','src/core/dependencies.cjs','src/core/local-deployment.cjs','src/core/external-launcher.cjs','src/ui/home-background.jpg','src/main.cjs','src/preload.cjs','src/ui/app.js','src/ui/library-categories.js','src/ui/index.html','src/ui/style.css','src/core/archive.cjs','src/core/rar-worker.cjs','src/core/library.cjs','src/core/launcher.cjs','src/core/gamebanana.cjs','src/core/network.cjs','src/core/install-service.cjs','src/core/updates.cjs','src/core/electron-fetch.cjs','src/core/hotkeys.cjs','src/core/hash-replace.cjs','src/core/download-queue.cjs','src/core/preferences.cjs']){
