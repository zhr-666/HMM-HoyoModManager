...
(async()=>{
  ...
  for(const file of ['src/core/media-response.cjs','src/core/game-data.cjs','src/core/settings.cjs','src/core/program-tabs.cjs','src/core/program-window-host.cjs','src/core/program-window-host.cs','src/core/program-window-host.ps1','src/core/game-hotkey-match.cjs','src/core/game-hotkey-monitor.cjs','src/core/game-screen-capture.cjs','src/core/game-ocr.cjs','src/core/game-hotkey-overlay.cjs','src/core/game-hotkey-overlay-settings.cjs','src/core/ocr-data/chi_sim.traineddata.gz','src/hotkey-overlay-preload.cjs','src/ui/hotkey-overlay.html','src/ui/hotkey-overlay.css','src/ui/hotkey-overlay.js','src/ui/program-tabs.js','src/ui/home-background.js','src/ui/genshin-logo.png','src/core/backgrounds.cjs','src/core/games.cjs','src/core/workspaces.cjs','src/core/mod-profile.cjs','src/core/preview-cache.cjs','src/core/character-groups.cjs','src/core/character-names.cjs','src/core/character-names.zh-CN.json','src/core/shader-fixes.cjs','src/ui/dialog-stack.js','src/core/dependency-prompts.cjs','src/core/app-update.cjs','src/core/update-helper.cjs','src/core/update-run.cjs','src/core/app-update.ps1','src/core/dependencies.cjs','src/core/local-deployment.cjs','src/core/external-launcher.cjs','src/ui/genshin-background.jpg','src/ui/zzz-background.jpg','src/ui/hsr-background.jpg','src/ui/zzz-logo.svg','src/ui/hsr-logo.png','src/main.cjs','src/preload.cjs','src/ui/app.js','src/ui/library-categories.js','src/ui/index.html','src/ui/style.css','src/core/archive.cjs','src/core/rar-worker.cjs','src/core/library.cjs','src/core/gamebanana.cjs','src/core/network.cjs','src/core/install-service.cjs','src/core/updates.cjs','src/core/electron-fetch.cjs','src/core/hotkeys.cjs','src/core/hash-replace.cjs','src/core/download-queue.cjs','src/core/preferences.cjs','src/core/kuro-background.cjs','src/ui/wuwa-background.jpg','src/ui/wuwa-icon.png','src/ui/wuwa-logo-zh.png']){
