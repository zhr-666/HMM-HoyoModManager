...
(async()=>{
  ...
  try{
    ...
    await page.evaluate(()=>window.configureMods());await page.locator('[data-page="settings"]').click();await page.locator('#page-title').click({button:'right'});await page.locator('#context-refresh').click();
    await page.locator('[data-page="workshop"]').click();
