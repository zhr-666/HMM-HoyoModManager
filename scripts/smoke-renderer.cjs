...
(async()=>{
  ...
  try{
    ...
    await page.locator('#refresh-button').click();await page.waitForTimeout(100);
    ...
    assert.equal(await page.locator('[data-testid="installed-mod"]').count(),2);
    ...
    await page.locator('.remove').click();await page.locator('#remove-confirm').click();
